...
public class CabinVoiceGenerator {
	...
	// Creating calculateFare method to calculate the fare for the given distance
	// and time
	...
	public static void main(String[] args) {
		System.out.println("Total Fair is : " + calculateFare(5.5, 10));// calling method calculateFare and pass
																		// distance and time
	}
}